...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioButton10=findViewById(R.id.radioButton13);
        radioButton11=findViewById(R.id.radioButton14);
        radioButton12=findViewById(R.id.radioButton15);
        ...
        reff.child("Candidates").child("VP").child("1").child("name").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(Main3Activity.this,databaseError.getCode(),Toast.LENGTH_SHORT).show();
                ...
                if(radbutton1 == radioButton1)
                {
                    ...
                    reff.child("Candidates").child("VP").child("1").child("votes").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            x1=x1+1;
                            Toast.makeText(Main3Activity.this,"Thanks for voting",Toast.LENGTH_LONG).show();
                ...
                db.collection("Users").document(uid)
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        if(documentSnapshot.exists()){
                            ...
                            if(sex.equals("cse"))
                            {
                                startActivity(new Intent(Main3Activity.this,cse.class));
                            }
                            if(sex.equals("ece"))
                            {
                                startActivity(new Intent(Main3Activity.this,ece.class));
                            }
                            if(sex.equals("civil"))
                            {
                                startActivity(new Intent(Main3Activity.this,civil.class));
                            }



                        }else{
                            Toast.makeText(Main3Activity.this, "Document does not exits", Toast.LENGTH_SHORT);
                        }
